...
contract NFTRewardALPA1 is IPool {
    ...
    */
        ...
        updateReward(msg.sender)
    {
        ...
        uint256[] storage gegoIds = _playerexo[msg.sender];
        if (exoIds.length == 0) {
            exoIds.push(0);    
            _exoMapIndex[0] = 0;
        }
    ...
    function withdrawGego(uint256 exoId)
        public
        updateReward(msg.sender)
    {
        ...
        uint256 exoIndex = _exoMapIndex[gegoId];
        ...
        emit WithdrawnGego(msg.sender, exoId);
    }
