...
import "../interface/EXOFactoryV2.sol";   
import "../library/EXOGuard.sol";

contract MarsClaim is EXOGuard {
    ...
    EXOFactoryV2 public  _EXOFactoryV2;
    EXOToken public  _EXOTokenV2;
    address public _EXORuleProxy;
    ...
    modifier checkRuleProxy {
        require(msg.sender == _EXORuleProxy, "not this EXORuleProxy");
        _;
    }

    // --- Init ---
    function initialize(
        EXOFactoryV2 EXOFactoryV2, 
        uint256 gegoId, 
        EXOToken EXOTokenV2, 
        address EXORuleProxy) 
        public 
    {
        ...
        _maxGrade = 6;
        _maxGradeLong = 20;
        _EXOFactoryV2 = EXOFactoryV2;
        _EXOTokenV2 = EXOTokenV2;
        _EXOId = EXOId;
        _EXORuleProxy = EXORuleProxy;
    ...
    function claim() public nonReentrant returns (uint256){
        ...
        EXOFactoryV2.MintData memory mintData = EXOFactoryV2.MintData(amount, _contributor.resBaseId, _contributor.nftType, _contributor.ruleId, _contributor.tLevel);
        EXOFactoryV2.MintExtraData memory mintExtraData = EXOFactoryV2.MintExtraData(_gegoId, grade, quality, msg.sender);
        
        _EXOFactoryV2.gmMint(mintData, mintExtraData);
