...
import "../library/EXOUtil.sol";


contract EXOArtToken is ERC721Full, Governance {
    // for minters
    mapping(address => bool) public _minters;

    constructor() public ERC721Full("gego.art", "EXO-ART") {
        _setBaseURI("https://api.exohood.com/bsccommon/exo-art-token/");
    }
