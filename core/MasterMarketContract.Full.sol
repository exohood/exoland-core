...
// File: contracts/market/MasterMarketContract.sol
...
contract MasterMarketContract is ReentrancyGuard {
    ...
    IERC20 public _exo = IERC20(0x0);
    bool public _isRewardSellerexo = false;
    bool public _isRewardBuyerexo = false;
    uint256 public _sellerRewardexo = 1e15;
    uint256 public _buyerRewardexo = 1e15;
    ...
    function initialize(
        ...
        _baseRate = baseRate;
        _exo = exo;
        _isRewardSellerexo = false;
        _isRewardBuyerexo = false;
        _sellerRewardexo = 1e15;
        _buyerRewardexo = 1e15;
        ...
        returns(uint)
    {
        ...
        if(_isRewardSellerexo) {
            _exo.mint(msg.sender, _sellerRewardexo);
        }
        ...
        payable 
    {
        ...
        if(_isRewardBuyerexo) {
            _exo.mint(msg.sender, _buyerRewardexo);
        }
        // fire event
        emit eveSales(
            index, 
    ...
    function setexoAddress(address addr) external onlyGovernance validAddress(addr) {
        _exo = IERC20(addr);
    }

    function setSellerRewardexo(uint256 rewardexo) public onlyGovernance {
        _sellerRewardexo = rewardexo;
    }

    function setBuyerRewardexo(uint256 rewardexo) public onlyGovernance {
        _buyerRewardexo = rewardexo;
    }

    function setIsRewardSellerexo(bool isRewardSellerexo) public onlyGovernance {
        _isRewardSellerexo = isRewardSellerexo;
    }

    function setIsRewardBuyerexo(bool isRewardBuyerexo) public onlyGovernance {
        _isRewardBuyerexo = isRewardBuyerexo;
    }
